...
Full documentation is available at **[https://f5xc-salesdemos.github.io/terraform-provider-mcp/](https://f5xc-salesdemos.github.io/terraform-provider-mcp/)**.

## Getting Started

```bash
git clone https://github.com/f5xc-salesdemos/terraform-provider-mcp.git
```

See the [documentation](https://f5xc-salesdemos.github.io/terraform-provider-mcp/) for detailed setup
and usage guides.
